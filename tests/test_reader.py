...
def cdc_reader(
    ...
    reader = pypgcdc.LogicalReplicationReader(
...
def validate_message_table_schema(message: pypgcdc.ChangeEvent, replica_identity_full: bool = False) -> None:
...
def test_close_connection(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
...
def test_insert(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
...
def test_update(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
    """with default replica identity"""
    cursor.execute(BASE_INSERT_STATEMENT)
    next(cdc_reader)
...
def test_update_key(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
    """with default replica identity"""
    cursor.execute(BASE_INSERT_STATEMENT)
    next(cdc_reader)
...
def test_delete(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
    """with default replica identity"""
    cursor.execute(BASE_INSERT_STATEMENT)
    next(cdc_reader)
...
def test_update_replica_identity_full(
    cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader
) -> None:
...
def test_truncate(cursor: psycopg2.extras.DictCursor, cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
    cursor.execute(BASE_INSERT_STATEMENT)
    next(cdc_reader)
...
def test_extractor_error(cdc_reader: pypgcdc.LogicalReplicationReader) -> None:
